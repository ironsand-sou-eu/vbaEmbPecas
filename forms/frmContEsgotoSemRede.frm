VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmContEsgotoSemRede 
   Caption         =   "Sísifo - Mestre, fale-me um pouco mais sobre o processo!"
   ClientHeight    =   8340
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   11310
   OleObjectBlob   =   "frmContEsgotoSemRede.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmContEsgotoSemRede"
...
Private Sub txtDataImplantacao_Exit(ByVal Cancel As MSForms.ReturnBoolean)
    Dim strCont As String
    
    strCont = Replace(txtDataImplantacao.Text, " ", "")
    ...
    Else ' Se não forem só números
        strCont = Trim(txtDataImplantacao.Text)
    
    End If
    
    txtDataImplantacao.Text = strCont
